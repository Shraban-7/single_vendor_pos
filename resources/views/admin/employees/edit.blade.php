...
<div class="flex flex-col gap-2 mb-5 sm:flex-row sm:items-center sm:justify-between">
    <div>
        <h1 class="text-xl font-bold tracking-tight text-slate-900">Edit Employee</h1>
        <p class="text-xs text-slate-500">Modify active profile settings and access credentials for this staff member.</p>
    </div>
    <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
                ...
                <div class="md:col-span-2">
                    <x-input
                        ...
                        placeholder="Update employee full name"
                        required
                ...
                <div class="md:col-span-2">
                    <x-input
                        ...
                        placeholder="Leave blank to maintain current identity parameters"
                        class="text-xs h-9 bg-slate-50/50 focus:bg-white placeholder:text-[10px]" />
